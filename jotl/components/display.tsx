...
const Display: React.FC<DisplayProps> = ({displayState, combatState, buttonState}) => {
    return (
        <>
          ...
          <div className="display-area m-24 block bg-black-10 border-2 border-black-20 p-5 rounded-lg shadow-md text-xl text-offWhite text-center flex-1 overflow-y-auto">
