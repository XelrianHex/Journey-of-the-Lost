...
const Combat: React.FC<CombatProps> = ({combatState, buttonState}) => {
    return (
    <div className="combat-display  m-24 hidden bg-black-10 border-2 border-black-20 p-5 rounded-lg shadow-md text-xl text-offWhite text-center flex-1 overflow-y-auto">
